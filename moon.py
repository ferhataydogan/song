...
def help(client, message):
    helptext = f'**📥 Telegram Müzik & Video İndirme Botudur, Tasarım Ferhatbey ...\n\n» /bul < müzik adı >\n    - Anında Müzik İndirir ...\n» /vbul < video adı >\n    - Anında Video İndirir ...**'
    message.reply_text(
        text=helptext, 
        quote=False,
        reply_markup=InlineKeyboardMarkup(
            [[
                    InlineKeyboardButton('💌 ʙᴇɴɪ ɢʀᴜʙᴀ ᴇᴋʟᴇ 💌', url=f'http://t.me/FerobeyBot?startgroup=new'),
                  ],[
                    InlineKeyboardButton('📚 ᴋᴀɴᴀʟ', url=f'https://t.me/SlotdünyasıMüzik')
                  ],[
                    InlineKeyboardButton('👤 ᴏᴡɴᴇʀ', url=f'https://t.me/FerobeyBot')
                  ]
            ]
        )
    )
